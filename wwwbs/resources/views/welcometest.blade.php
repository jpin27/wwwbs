	    	...
	    	<div class="row">
	        	...
	        	<div class="col-lg-10 mx-auto">
	            	<h1 class="text-uppercase">
	              		<strong>Welcome to the Student Wellness Centre</strong>
	            	</h1>
	            	<hr>
	          	</div>

	        	<div class="col-lg-8 mx-auto">
	            	<p class="text-faded mb-5">Book an appointment online for your medical wellness... things. Get started today!</p>
